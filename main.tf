// C// Copyright (c) 2018-2021 Zededa, Inc.
...
#   project_id  = zedcloud_project.test_tf_provider.id
#   asset_ids {
#     ids = [ zedcloud_edgenode.test_tf_provider.id ]
#   }
# }
...
# data "zedcloud_app_profile" "test_tf_provider" {
#   name     = "test_tf_provider"
#   title    = "test_tf_provider"
#   depends_on = [
#     zedcloud_app_profile.test_tf_provider
#   ]
# }
...
#   title = "test_tf_provider"
#   app_profile_info {
#     app_profile_id = zedcloud_app_profile.test_tf_provider.id
#     version = 2
#   }
#   target_asset_group {
